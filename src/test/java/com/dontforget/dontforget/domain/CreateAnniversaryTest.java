...
class CreateAnniversaryTest {
    ...
    void sut_create_anniversary_success(
        ...
        final CalendarCalculator calculator = new CalendarCalculator(new KoreanLunarCalendarCalculator());
        ...
        final List<NoticeEntity> noticeEntities = noticeEntityRepository.findAllByAnniversaryId(anniversaryId);
